...
namespace Controllers.Mob.Boss
{
    ...
    public class BearBossController : EntityController
    {
        ...
        [SerializeField] private List<AudioClip> getHitSounds;
        [SerializeField] private List<AudioClip> roarSounds;
        ...
        public void IdleSounds()
        {
            ...
            Managers.Sound.Play(idleSounds[rand], Define.Sound.Effect, 0.8f, 0.7f);
        }

        public void StepSounds()
        {
            int rand = Random.Range(0, stepSounds.Count);
            Managers.Sound.Play(stepSounds[rand], Define.Sound.Effect, 0.7f, 0.4f);
        }

        private void GetHitSounds()
        {
            int rand = Random.Range(0, getHitSounds.Count);
            Managers.Sound.Play(getHitSounds[rand], Define.Sound.Effect, 0.4f, 0.5f);
        }

        public void RoarSounds()
        {
            int rand = Random.Range(0, roarSounds.Count);
            Managers.Sound.Play(roarSounds[rand], Define.Sound.Effect, 0.7f, 1f);
        }
